...
export const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-900 text-white mt-auto">
      <div className="px-6 py-16 lg:py-20 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center border-b border-gray-800 pb-16 mb-12">
          ...
          <div className="flex flex-col items-start lg:items-end shrink-0">
            <button className="w-full lg:w-auto bg-primary hover:bg-secondary text-white font-bold py-4 px-10 rounded-2xl shadow-lg shadow-green-900/50 flex items-center justify-center transition-all transform hover:-translate-y-1 mb-3">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
          <div className="flex items-center space-x-2 mb-6 md:mb-0">
             <Icon name="eco" className="text-primary text-2xl" filled />
             <span className="text-lg font-bold text-white">FastTrack</span>
          </div>
